/* This program is to evaluate derivative using 2 point method for different step sizes 'h' 
...
for (N=1;N<=pow(10,8);N=N*10){
    float h1 = a/N;
    float diff1 = (func1((pow(2,0.5)+h1))-func1(pow(2,0.5)))/h1;
    cout<<diff1<<endl;
...
for (N=1;N<=pow(10,16);N=N*10){
    double h2 = a/N;
    double diff2 = (func2((pow(2,0.5)+h2))-func2(pow(2,0.5)))/h2;
    cout<<diff2<<endl;
